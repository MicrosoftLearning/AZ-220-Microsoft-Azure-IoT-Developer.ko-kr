...
1. Azure Portal에서 iot-az220-training-{your-id}로 이동합니다. IoT 디바이스를 선택합니다. sensor-th-0084를 클릭합니다. 부모 디바이스 옆에 있는 기어 아이콘을 클릭합니다. vm-az220-training-gw0002-{your-id}를 선택합니다. 확인을 클릭합니다.
...
1. **런타임 설정** 창에서 **Edge 허브** 탭을 클릭한 다음 **저장소 및 전달 구성 - TTL(Time to Live)(초)** 필드를 찾습니다.
